...
*/
(function () {
  var o, u, x, y, z, r, v, A, E, B, F, G, q, s, p, k, t, C, H, D = {}.hasOwnProperty, j = [].indexOf || function (a) {
  ...
  var w = function (a) {
    var c, b;
    for (c in a) D.call(a, c) && (b = a[c], !1 !== b && (this[c] = b));
    this.keys = this.keys || [];
  ...
  var g = function (a, c) {
    ...
    this._defaults = c || {};
    for (b in r) D.call(r, b) && (d = r[b], this._defaults[b] = this._defaults[b] || d);
    ...
    var f = this;
    this.keyup_event = b(this.element,
        "keyup", function (a) {
          a = a || window.event;
  ...
  g.prototype.destroy = function () {
    var a;
    a = function (a, b, d) {
      if (null != a.removeEventListener) return a.removeEventListener(b, d);
      if (null != a.removeEvent) return a.removeEvent("on" + b, d)
    };
  ...
  g.prototype._prevent_default = function (a, c) {
    if ((c || this.should_suppress_event_defaults) && !this.should_force_event_defaults) if (a.preventDefault ? a.preventDefault() :
        a.returnValue = !1, a.stopPropagation) return a.stopPropagation()
  };
  ...
  g.prototype._get_potential_combos = function (a) {
    ...
    d = 0;
    for (e = f.length; d < e; d++) c = f[d], c.is_sequence || 0 <= j.call(c.keys, a) && this._cmd_bug_check(c.keys) && b.push(c);
    return b
  };
  g.prototype._add_to_active_combos = function (a) {
    ...
    if (this._active_combos.length) {
      e = i = 0;
      for (l = this._active_combos.length; 0 <= l ? i < l : i > l; e = 0 <= l ? ++i : --i) if ((c = this._active_combos[e]) && c.is_exclusive && a.is_exclusive) {
        c = c.keys;
        if (!h) {
          g = 0;
          for (n = c.length; g < n; g++) if (b = c[g],
              h = !0, 0 > j.call(a.keys, b)) {
            h = !1;
            break
          }
        }
        if (f && !h) {
          m = a.keys;
          g = 0;
          for (n = m.length; g < n; g++) if (b = m[g], f = !1, 0 > j.call(c, b)) {
            f = !0;
            break
          }
        }
  ...
  g.prototype._remove_from_active_combos = function (a) {
    ...
    for (e = this._active_combos.length; 0 <= e ? d < e : d > e; b = 0 <= e ? ++d : --d) if (c = this._active_combos[b], c === a) {
      a = this._active_combos.splice(b,
          1)[0];
      a.reset();
      break
    }
  ...
  g.prototype._get_possible_sequences = function () {
    ...
    for (g = n.length; f < g; f++) {
      a = n[f];
      c = h = 1;
      for (l = this._sequence.length; 1 <= l ? h <= l : h >= l; c = 1 <= l ? ++h : --h) if (e = this._sequence.slice(-c), a.is_sequence) {
        if (0 > j.call(a.keys, "shift") && (e = v(e, function (a) {
          return "shift" !== a
        }), !e.length)) continue;
        c = i = 0;
        for (m = e.length; 0 <= m ? i < m : i > m; c = 0 <= m ? ++i : --i) if (a.keys[c] === e[c]) b = !0; else {
          b = !1;
          break
        }
        b && d.push(a)
  ...
  g.prototype._add_key_to_sequence =
      function (a, c) {
        var b, d, e, f;
        ...
        if (d.length) {
          e = 0;
          for (f = d.length; e < f; e++) b = d[e], this._prevent_default(c, b.prevent_default);
  ...
  g.prototype._get_sequence = function (a) {
    ...
    h = 0;
    for (n = l.length; h < n; h++) if (c =
        l[h], c.is_sequence) {
      b = i = 1;
      for (m = this._sequence.length; 1 <= m ? i <= m : i >= m; b = 1 <= m ? ++i : --i) if (f = v(this._sequence, function (a) {
        return 0 <= j.call(c.keys, "shift") ? !0 : "shift" !== a
      }).slice(-b), c.keys.length === f.length) {
        b = g = 0;
        for (k = f.length; 0 <= k ? g < k : g > k; b = 0 <= k ? ++g : --g) if (e = f[b], !(0 > j.call(c.keys, "shift") && "shift" === e) && !("shift" === a && 0 > j.call(c.keys, "shift"))) if (c.keys[b] === e) d = !0; else {
          d = !1;
          break
        }
      }
  ...
  g.prototype._receive_input = function (a, c) {
    var b, d;
    if (this._prevent_capture) this._keys_down.length &&
    (this._keys_down = []); else if (b = y(null != (d = a.keyCode) ? d : a.key), (c || this._keys_down.length || !("alt" === b || b === k)) && b) return c ? this._key_down(b, a) : this._key_up(b, a)
  };
  ...
  g.prototype._match_combo_arrays = function (a, c) {
    ...
    e = 0;
    for (f = h.length; e < f; e++) d = h[e], b = a.slice(0), d.normalize_caps_lock &&
  ...
  g.prototype._fuzzy_match_combo_arrays = function (a, c) {
    ...
    f = this._registered_combos;
    d = 0;
    for (e = f.length; d < e; d++) b = f[d], (!b.is_unordered && B(b.keys, a) || b.is_unordered && E(b.keys, a)) && c(b)
  };
  g.prototype._keys_remain = function (a) {
    var c, b, d, e;
    e = a.keys;
    b = 0;
    for (d = e.length; b < d; b++) if (a = e[b], 0 <= j.call(this._keys_down, a)) {
      c = !0;
      break
    }
    return c
  ...
  g.prototype._key_down = function (a, c) {
    ...
    for (e in t) b = t[e], c[b] && (e === a || 0 <= j.call(this._keys_down, e) || this._keys_down.push(e));
    for (e in t) if (b = t[e], e !== a && 0 <= j.call(this._keys_down, e) && !c[b] && !("cmd" === e && "cmd" !== k)) {
      b = d = 0;
      for (f = this._keys_down.length; 0 <= f ? d < f : d > f; b = 0 <= f ? ++d : --d) this._keys_down[b] === e && this._keys_down.splice(b, 1)
    }
    d = this._get_active_combos(a);
    e = this._get_potential_combos(a);
    f = 0;
    for (h = d.length; f < h; f++) b = d[f], this._handle_combo_down(b,
        e, a, c);
    if (e.length) {
      d = 0;
      for (f = e.length; d < f; d++) b = e[d], this._prevent_default(c, b.prevent_default)
    }
  ...
  g.prototype._handle_combo_down = function (a, c, b, d) {
    ...
    if (a.is_exclusive) {
      g = 0;
      for (k = c.length; g < k; g++) if (f = c[g], f.is_exclusive && f.keys.length >
      a.keys.length) {
        b = !0;
        break
      }
  ...
  g.prototype._key_up = function (a, c) {
    ...
    f = h = 0;
    for (g = this._keys_down.length; 0 <= g ? h < g : h > g; f = 0 <= g ? ++h : --h) if ((d = this._keys_down[f]) === a || d === e || d === b) {
      this._keys_down.splice(f,
          1);
      break
    }
    ...
    f = 0;
    for (h = g.length; f < h; f++) b = g[f], 0 <= j.call(b.keys, a) && e.push(b);
    f = 0;
    for (h = e.length; f < h; f++) b = e[f], this._handle_combo_up(b, c, a);
    if (1 < d) {
      h = this._active_combos;
      d = 0;
      for (f = h.length; d < f; d++) b = h[d], void 0 === b || 0 <= j.call(e, b) || this._keys_remain(b) || this._remove_from_active_combos(b)
    }
  };
  g.prototype._handle_combo_up = function (a, c, b) {
    ...
    if (!a.keyup_fired && (d = this._keys_down.slice(),
        d.push(b), !a.is_solitary || u(d, a.keys))) this._fire("keyup", a, c), a.is_counting && ("function" === typeof a.on_keyup && "function" !== typeof a.on_keydown) && (a.count += 1);
  ...
  g.prototype.register_combo = function (a) {
    ...
    d = this._defaults;
    for (c in d) D.call(d, c) && (b = d[c], void 0 === a[c] && (a[c] = b));
    a = new w(a);
  ...
  g.prototype.unregister_combo = function (a) {
    ...
    b = function (a) {
      ...
      e = [];
      b = c = 0;
      for (d = i._registered_combos.length; 0 <= d ? c < d : c > d; b = 0 <= d ? ++c : --c) if (a === i._registered_combos[b]) {
    ...
    if ("string" === typeof a) {
      a = a.split(" ");
      c = d = 0;
      for (e = a.length; 0 <= e ? d < e : d > e; c = 0 <= e ? ++d : --d) "meta" === a[c] && (a[c] = k)
    }
    f = this._registered_combos;
    g = [];
    d = 0;
    for (e = f.length; d < e; d++) c = f[d], null != c && (c.is_unordered && u(a, c.keys) || !c.is_unordered && x(a, c.keys) ? g.push(b(c)) : g.push(void 0));
    return g
  };
  g.prototype.unregister_many =
      function (a) {
        var c, b, d, e;
        e = [];
        b = 0;
  ...
  u = function (a, c) {
    ...
    d = 0;
    for (e = a.length; d < e; d++) if (b = a[d], !(0 <= j.call(c, b))) return !1;
    return !0
  };
  x = function (a, c) {
    var b, d, e;
  ...
  A = Array.prototype.indexOf || function (a, c) {
    var b, d, e;
    b = d = 0;
    for (e = a.length; 0 <= e ? d <= e : d >= e; b = 0 <= e ? ++d : --d) if (a[b] === c) return b;
    return -1
  };
  B = function (a, c) {
    var b, d, e, f;
    e = d = 0;
    for (f = a.length; e < f; e++) if (b = a[e], b = A.call(c, b), b >= d) d = b; else return !1;
    return !0
  };
  p = function () {
  ...
  H = function (a) {
    ...
    b = g = 0;
    for (i = a.keys.length; 0 <=
    i ? g < i : g > i; b = 0 <= i ? ++g : --g) d = a.keys[b], (c = G[d]) && (d = a.keys[b] = c), "meta" === d && a.keys.splice(b, 1, k), "cmd" === d && p('Warning: use the "meta" key rather than "cmd" for Windows compatibility');
    i = a.keys;
    c = 0;
    for (g = i.length; c < g; c++) d = i[c], F(d) || (p('Do not recognize the key "' + d + '"'), f = !1);
    if (0 <= j.call(a.keys, "meta") || 0 <= j.call(a.keys, "cmd")) {
      c = a.keys.slice();
      g = 0;
      for (i = C.length; g < i; g++) d = C[g], -1 < (b = A.call(c, d)) && c.splice(b, 1);
      1 < c.length && (p("META and CMD key combos cannot have more than 1 non-modifier keys", a,
          c), f = !1)
    }
    for (e in a) "undefined" === r[e] && p("The property " + e + " is not a valid combo property. Your combo has still been registered.");
    return f
  };
  z = function (a, c) {
    var b;
  ...
  t = {cmd: "metaKey", ctrl: "ctrlKey", shift: "shiftKey", alt: "altKey"};
  G = {
    escape: "esc",
    control: "ctrl",
    command: "cmd",
  ...
  "function" === typeof define && define.amd ? define([], function () {
    return o
  }) : "undefined" !== typeof exports && null !== exports ? exports.keypress = o : window.keypress = o
}).call(this);
